...
* Each hedge's node id should be set using the node/pod's IP address:port. In Kubernetes, you can use [downward API](https://kubernetes.io/docs/concepts/workloads/pods/downward-api/) to get the pod's IP address, or you can use the ":port" format in which case the IP address will be resolved internally.
